...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@piclaw/agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@piclaw/ai/compat";
import { completeSimple } from "@piclaw/ai/compat";
import {
	convertToLlm,
