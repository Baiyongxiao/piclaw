            ...
            >
              {isMobile ? (
                <div style={{ display: "flex", flexDirection: "column", gap: 4, minWidth: 0, flex: 1 }}>
                  <span style={{ fontSize: 22, fontWeight: 700, letterSpacing: "-0.01em", color: "var(--text)" }}>π Pi Agent Web</span>
                  <span style={{ fontSize: 14, color: "var(--text-muted)", minWidth: 0, overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>
